import type { InlineQueryResult, InlineQueryResultsButton } from "@telegraf/types/inline";
import type { ForceReply, InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardRemove } from "@telegraf/types/markup";
import type { BotCommand, ChatAdministratorRights, ChatFromGetChat, ChatInviteLink, ChatMember, ChatMemberAdministrator, ChatMemberOwner, ChatPermissions, File, ForumTopic, ReactionType, UserChatBoosts, UserFromGetMe, UserProfilePhotos, WebhookInfo } from "@telegraf/types/manage";
import type { GameHighScore, LinkPreviewOptions, MaskPosition, Message, MessageEntity, MessageId, ParseMode, Poll, ReplyParameters, SentWebAppMessage, Sticker, StickerSet } from "@telegraf/types/message";
import type { PassportElementError } from "@telegraf/types/passport";
import type { LabeledPrice, ShippingOption } from "@telegraf/types/payment";
import type { BotCommandScope, BotDescription, BotName, BotShortDescription, MenuButton } from "@telegraf/types/settings";
import type { Update } from "@telegraf/types/update";
